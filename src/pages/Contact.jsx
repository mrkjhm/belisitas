    ...
    <>
      <div className=' bg-[#EDEDED]  flex justify-center'>
        <div className='items-center lg:px-50 md:px-7 sm:px-33 px-[15px] grid lg:grid-cols-2 md:grid-rows-1  lg:mt-20 lg:gap-10 lg:pb-0 pb-10 '>
          ...
          <div className='container mx-auto flex justify-center items-center lg:px-0 sm:px-33 px-[15px]'>
      ...
      <div className=' text-center p-6 py-20 lg:px-32 w-full overflow-hidden px-10' id='contact'>
        ...
        <p className='text-gray-500 max-w-85 text-center mx-auto'>Transform Your Space with Handcrafted Rattan.
          Contact Us Today!</p>
        <div className='flex md:flex-row flex-col md:gap-30 gap-5  justify-center md:my-25 my-15'>
        ...
        <div className='flex md:flex-row flex-col xl:gap-40 lg:gap-20 gap-10 justify-center mt-20'>
          <div className='  rounded-2xl flex items-center justify-center md:mb-0 mb-20'>

          <img  src={assets.chair_3} alt="" />
          </div>
          <div className='flex justify-center items-center'>
            <form onSubmit={onSubmit} action="" className='max-w-2xl mx-auto text-gray-500 '>
              ...
              <button className='bg-[#0D2893] text-white py-2 px-12 rounded flex'>{result ? result : "Send Message"}</button>
            </form>
          </div>
        </div>
      </div>
